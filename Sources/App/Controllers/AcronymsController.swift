...
struct AcronymsController:RouteCollection {
    ...
    func boot(router: Router) throws {
        ...
        tokenAuthGroup.post(AcronymCreateData.self, use: createHandlerWithToken)
    }
    ...
    func createHandlerWithToken(_ req: Request, data: AcronymCreateData) throws -> Future<Acronym> {
        let user = try req.requireAuthenticated(User.self)
        let acronym = try Acronym(short: data.short,
            long: data.long, userID: user.requireID())
        return acronym.save(on: req)
